...
export function ConvertData(data: any[]): GeneratorChartData {
    ...
    const allocatedMUs: number[] = data.map(entry => parseFloat( entry.allocated_capactity) < 0 ? 0 : entry.allocated_capactity);
