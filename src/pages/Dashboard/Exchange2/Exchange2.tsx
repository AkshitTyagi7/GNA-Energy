...
import { RealTimeChartData, formatRealTimeChartData } from "./FormatData";
  ...
  return (
    <>
      ...
      </div>
      {
        ...
        <>
                  <div className="flex flex-row justify-between mt-3" style={{width:"98%"}}>
        ...
        <div className="byExchangeChart mt-">
          <ResponsiveContainer>
            <ExchangeChart data={
              byExchangeIndex === 0 ? iexData.dam : byExchangeIndex === 1 ? pxilData.dam : hpxData.dam
          
            } title="DAM" syncId="byProduct" />
          </ResponsiveContainer>

          <ResponsiveContainer>
            <ExchangeChart data={
              byExchangeIndex === 0 ? iexData.gdam : byExchangeIndex === 1 ? pxilData.gdam : hpxData.gdam
          
            } title="GDAM" syncId="byProduct" />
          </ResponsiveContainer>

        </div><div className="byExchangeChart">
            <ResponsiveContainer>
              <ExchangeChart data={
                byExchangeIndex === 0 ? iexData.hpdam : byExchangeIndex === 1 ? pxilData.hpdam : hpxData.hpdam
          
              
              } title="HPDAM" syncId="byProduct" />
            </ResponsiveContainer>

            <ResponsiveContainer>
              <ExchangeChart data={
                byExchangeIndex === 0 ? iexData.rtm : byExchangeIndex === 1 ? pxilData.rtm : hpxData.rtm
              } title="RTM" syncId="byProduct" />
            </ResponsiveContainer></div>
          <ExchangeChart data={iexData.dam}
          
          title="DAM" syncId="byProduct" height="5%" width="99%" showBrush={true} onlyBrush={true} />
      ...
      } 
      {
        ...
        <div className="justify-between container-chart">
          ...
          <div className="realtime-container">
            ...
            <div className="flex justify-center realTimeChart text-center  w-full content-center" style={{
              height:"60vh"
            }}>
              <RawLineChart data={
