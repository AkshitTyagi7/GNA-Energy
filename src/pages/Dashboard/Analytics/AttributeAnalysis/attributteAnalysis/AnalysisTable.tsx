...
import { COST, COST_UNIT, GENERATION_UNIT } from '../../../../../components/charts/data/Units';
...
interface TableRecord {
    //This object in the interface is used to store the data of the table 
    // {
    //     "Actual_Mus": 87.24,
    //     "Adjusted_Availability": "0.7904 %",
    //     "Adjusted_Mus": 165.98,
    //     "Adjusted_variable_charge": 4.45,
    //     "Availability": "0.7904 %",
    //     "Generator": "Bhusawal 3",
    //     "actual_cost": 38.82,
    //     "allocated_capactity": 210,
    //     "cap_util": 41.542857142857144,
    //     "variable_charge": 4.45,
    //     "variable_cost": 73.86
    // }
    
    //Add all the attributes of the table here
...
function TableRow({
    ...
    return (
        <tr>
            ...
            {isAdjusted ?    <Slider
                        currentValue={(parseFloat(record.Availability.toString().replace('%', ''))*100).toFixed(2)}
                        minValue={0}
                        maxValue={100}
...
export default function AnalysisTable() {
    ...
    const [data, setData] = useState<Data>({ data: [], cost: ['-', '-', '-'], date_list: [], weighted_avg: [], source: [], ppa: [], ownership: [], net_charge: [], energy_charge: [], eff_rate: [], cost_of_gen: [], cap_util: [], total_cost: [], ppa_util: [], mus:{} });
        ...
        <div className='AnalysisBody'>
            ...
            <Cards />
                <div className='chartArea flex'>
                                ...
                                <div className='col'>
                                    ...
                                    <div className='col-2'>
                                        <Bar data={
                                            ...
                                            options={
                                                msedChartIndex === 0 ? GetChartOptions({ textTitle: `Total Generation (${GENERATION_UNIT})`, yLabelText: GENERATION_UNIT, displayYLabel: true, displayLegend: true }) :
                        ...
                        <div className='col mahagenco'>
                            ...
                            <div className='col-2'>
                                <BarChart data={
                                    ...
                                    options={
                                        // mahagencoChartIndex === 0 ? GetChartOptions({ textTitle: `Total Generation (${GENERATION_UNIT})`, yLabelText: GENERATION_UNIT, displayYLabel: true, displayLegend: false }) :
                    ...
                    <div className='col piecharts'>
                        <div className='row'>
                            <div className='col-3'>
                                <PieChart data={ConvertSourceData(data.source)} options={GetChartOptions({ textTitle: "Source", yLabelText: "Plants", displayYLabel: true, displayLegend: true })} />
                            </div>
                            <div className='col-3'>
                                <PieChart data={ConvertOwnershipData(data.ownership)} options={GetChartOptions({ textTitle: "Ownership", yLabelText: "Plants", displayYLabel: true, displayLegend: true })} />
                            </div>
                            <div className='col-3'>
    ...
    function SearchSelect() {
        return (
            <><h1 className='title-5'>Attribution Analysis</h1><Select
                className='select'
    ...
    async function fetchTableData() {
        try {
            ...
            if (isFirst == true) {
                ...
                selectDate(newdata.date_list[0]);
